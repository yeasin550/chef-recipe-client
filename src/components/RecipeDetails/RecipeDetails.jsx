...
const RecipeDetails = () => {
    ...
    return (
      <div className="mt-3 mx-12">
        ...
        {/* <div>
          <div className="mt-32">
            <footer className="px-8 divide-y bg-gray-800 text-white mt-12">
              <div className="container flex flex-col justify-between py-10 mx-auto space-y-8 lg:flex-row lg:space-y-0">
                <div className="lg:w-1/3 px-10">
                  ...
                  <span>Banana recipes</span> <br />
                  <span>Rajma/ red kidney bean recipes</span> <br />
                  <span>Okra/ ladies finger recipes</span> <br />
                  <span>Potato recipes</span> <br />
                </div>
                <div className="grid grid-cols-2 text-sm gap-x-3 gap-y-8 lg:w-2/3 sm:grid-cols-4">
                  ...
                  <div className="space-y-3">
                    ...
                    <div className="flex justify-start space-x-3">
                      <a
                        title="Facebook"
                        className="flex items-center p-1 text-sky-600"
                      >
                        <svg
                      ...
                      <a
                        ...
                        href="#"
                        title="Instagram"
                        className="flex items-center p-1 text-red-700"
                      >
                        <svg
                          xmlns="http://www.w3.org/2000/svg"
                          viewBox="0 0 32 32"
