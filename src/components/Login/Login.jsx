        ...
        >
          ...
          <div className="flex mt-3 gap-2">
            <button
              ...
              className="relative flex items-center justify-center w-48 mr-4 gap-2 py-2 px-4  bg-gradient-to-r from-orange-500 to-indigo-500 text-white rounded-lg shadow-md transition-all hover:shadow-lg hover:bg-gradient-to-r hover:from-pink-500 hover:to-red-500"
            >
