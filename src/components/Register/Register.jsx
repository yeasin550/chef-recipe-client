...
const Register = () => {
  ...
  const { createUser, googleSingIn, githubSignIn } = useContext(AuthContext);
        ...
        >
          ...
          <div className="flex mt-3 gap-2">
            <button
              ...
              class="relative flex items-center justify-center w-48 mr-4 gap-2 py-2 px-4  bg-gradient-to-r from-green-500 to-indigo-500 text-white rounded-lg shadow-md transition-all hover:shadow-lg hover:bg-gradient-to-r hover:from-pink-500 hover:to-red-500"
            >
              <div class="absolute inset-0 bg-red-500 rounded-lg transform scale-0 transition-transform"></div>
              ...
              <span class="text-white font-sm">Google Sign in</span>
            </button>
            <button
              onClick={handleGithubSingIn}
              class="flex items-center justify-center  w-48  gap-2 py-2 px-4 bg-gradient-to-r from-gray-800 to-orange-900 text-white rounded-lg shadow-md"
            >
              <svg
